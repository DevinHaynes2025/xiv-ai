...
| SQL migration `20260906220000_persistent_organizations_and_universes.sql` | MIGRATION AUTHORED — NOT APPLIED |
...
Do not execute a destructive rollback script in 2F-A.
