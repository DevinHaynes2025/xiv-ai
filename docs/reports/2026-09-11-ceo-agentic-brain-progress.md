...
| GitHub | VERIFIED for repository workflow | PRs/branches active through 12D-89; 12D-90+ mirror is still outstanding. |
...
| Claude Code | VERIFIED as local CLI/reviewer, remote model availability variable | Claude Code executed read/review work and 12D-85→88 contracts locally; provider classifier experienced temporary cloud timeouts. Do not treat Claude inference as offline/private. |
...
- GitHub is behind GitLab by the 12D-90 Ollama runtime bridge and 12D-91 alignment control-plane work.
...
2. Mirror 12D-90/91 to GitHub and compare blobs to remove repository drift.
