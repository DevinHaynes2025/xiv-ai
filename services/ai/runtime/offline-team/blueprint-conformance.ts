...
export function buildBlueprintReport(branch: string, checks: readonly BlueprintCheck[], now = new Date()): BlueprintReport {
  ...
  return Object.freeze({ generatedAt: now.toISOString(), branch, checks: Object.freeze(checks.map((c) => Object.freeze({ ...c, evidence: Object.freeze([...c.evidence]) }))), productionReady: false });
}
