...
export const CONFIDENTIAL_VAULT_GUARDRAILS = Object.freeze({ humanDecision: 'REQUIRED' as const,  plaintextSecretsInSourceAllowed:false, secretValuesInLogsAllowed:false, topSecretRequiresExternalSecretStore:true, tenantIsolationRequired:true } as const );
