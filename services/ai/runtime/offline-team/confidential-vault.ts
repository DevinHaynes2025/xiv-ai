...
export const CONFIDENTIAL_VAULT_GUARDRAILS = { plaintextSecretsInSourceAllowed:false, secretValuesInLogsAllowed:false, topSecretRequiresExternalSecretStore:true, tenantIsolationRequired:true } as const;
