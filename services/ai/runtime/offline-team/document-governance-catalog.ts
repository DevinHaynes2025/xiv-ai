...
export const DOCUMENT_GOVERNANCE_GUARDRAILS = Object.freeze({ humanDecision: 'REQUIRED' as const,  topSecretIndexingAllowed:false, crossTenantLeakageAllowed:false, secretsInEmbeddingsAllowed:false } as const );
