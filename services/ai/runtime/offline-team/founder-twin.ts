...
export function buildFounderTwin(input: { principles: readonly FounderPrinciple[]; decisionStyle?: readonly string[] }): FounderTwinProfile {
  ...
  return Object.freeze({ identity:'Devin Xavier Haynes', role:'CEO_AND_COFOUNDER', principles:Object.freeze([...input.principles]), decisionStyle:Object.freeze([...(input.decisionStyle ?? ['vision-led','evidence-seeking','lean-iteration','offline-first'])]), authority:'ADVISORY_ONLY', literalMindClone:false });
}
