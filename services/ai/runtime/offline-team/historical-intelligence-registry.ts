...
export const HISTORICAL_INTELLIGENCE_GUARDRAILS= Object.freeze({ humanDecision: 'REQUIRED' as const, realPersonCloneClaimAllowed:false,simulationPersonaOnly:true,sourceRequired:true,privateDocumentIngestAllowed:false,financialSecretExportAllowed:false} as const );
