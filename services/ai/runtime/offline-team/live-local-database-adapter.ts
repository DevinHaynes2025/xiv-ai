...
export interface LocalDbConfig { tenantId: string; engine: LocalDbEngine; path: string; encryptedAtRest: boolean; localhostOnly: true; }
export interface LocalDbReceipt { tenantId: string; engine: LocalDbEngine; path: string; schemaVersion: number; health: LocalDbHealth; verifiedAt?: string; receiptHash: string; }
