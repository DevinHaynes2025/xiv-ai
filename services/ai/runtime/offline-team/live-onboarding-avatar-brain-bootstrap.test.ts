...
const receipt = { userId:'user-1', tenantId:'tenant-1', state:'ENROLLED' as const, identityVerified:true, mfaVerified:true, contractsAccepted:true, privacyConfigured:true, deviceTrusted:true, consentRefs:['consent:1'] };
