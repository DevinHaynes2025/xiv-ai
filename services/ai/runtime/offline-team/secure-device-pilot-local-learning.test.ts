...
const enrollment={userId:'u1',tenantId:'t1',deviceId:'d1',enrolledAt:new Date(0).toISOString(),consentVersion:'1',capabilities:['FILES_READ','LOCAL_MODELS'] as const,biometricOrPasskeyVerified:true,mfaVerified:true,recoveryConfigured:true,auditEnabled:true,killSwitchEnabled:true};
