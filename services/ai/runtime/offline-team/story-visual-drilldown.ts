...
export interface DrilldownLayer { level: 'STORY' | 'EVIDENCE' | 'RAW'; title: string; payload: unknown; }
export function buildStoryDrilldown(card: StoryVisualCard): DrilldownLayer[] { return [
