...
export interface VisualEvidencePoint { label: string; value: number; unit?: string; timestamp?: string; evidenceRefs: string[]; }
export interface VisualStoryCard { cardId: string; tenantId: string; industry: string; title: string; stage: StoryStage; visualType: VisualType; summary: string; points: VisualEvidencePoint[]; confidence: number; evidenceRefs: string[]; }
